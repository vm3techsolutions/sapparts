    ...
    <div className="Section bg-white ">
      <div>
        ...
        <div className="w-full md:w-1/2 -mt-10 sm:mt-2">
          <h3 className = "text-[#000000] text-2xl mb-4 font-bold ">SAP Parts Seal Installation Tool:</h3>
...
{/* Approved Assembly Lubricants: */}
      ...
      <div className="flex flex-col md:flex-row sm:gap-8 items-start pt-10">
        {/* Mobile View - Title */}
         ...
         {/* Left Side - Text */}
        <div className="w-full md:w-1/2 -mt-10 sm:mt-2 ">
          <h3 className = "text-[#000000] text-2xl mb-4 font-bold ">Duo Cone Seal Installation Process:</h3>
...
{/* Steps By Step Seal Installation: */}
        ...
        <div className="w-full  -mt-6 sm:mt-2 pt-10">
          <h3 className = "text-[#000000] text-2xl mb-4 font-bold ">Steps By Step Seal Installation:</h3>
         ...
         <div className="w-full  -mt- sm:mt-2 ">
