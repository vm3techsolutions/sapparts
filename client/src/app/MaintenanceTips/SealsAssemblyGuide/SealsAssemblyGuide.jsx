...
export default function SealsAssemblyGuide() {
    ...
    <div className="Section bg-white ">
      <div className="flex flex-col md:flex-row sm:gap-8 items-start">
        ...
        <div className="w-full md:w-1/2 mt-6 sm:mt-2">
          ...
          <h3 className = "text-[#FACC48] text-2xl mb-4 font-bold hidden md:block">Guidelines For Duo-Cone Seals Installation</h3>

          <h3 className = "text-[#000000] text-2xl mb-4 font-bold hidden md:block">Mechanical Seal Design</h3>
          ...
          <div>
           ...
           <h3 className = "text-2xl mb-4 font-bold hidden md:block pt-10">Terminology:</h3> 
  ...
  <div className="flex flex-wrap gap-8 pl-10 pt-2 pb-2">
  <Image
