...
//   const rows = t("technicalSpecs2.table.rows", { returnObjects: true });

//   return (
//     <div className="Section bg-white">
//       <h2 className="Heading text-center mb-2">
//         {t("technicalSpecs2.sectionTitle")}
//       </h2>
