...
export default function TechnicalSpecs() {
  ...
  const rows = [
    { feature: t("technicalSpecs.row1.feature"), benefit: t("technicalSpecs.row1.benefit") },
    { feature: t("technicalSpecs.row2.feature"), benefit: t("technicalSpecs.row2.benefit") },
    { feature: t("technicalSpecs.row3.feature"), benefit: t("technicalSpecs.row3.benefit") },
    { feature: t("technicalSpecs.row4.feature"), benefit: t("technicalSpecs.row4.benefit") },
    { feature: t("technicalSpecs.row5.feature"), benefit: t("technicalSpecs.row5.benefit") },
    { feature: t("technicalSpecs.row6.feature"), benefit: t("technicalSpecs.row6.benefit") },
    { feature: t("technicalSpecs.row7.feature"), benefit: t("technicalSpecs.row7.benefit") },
  ];
