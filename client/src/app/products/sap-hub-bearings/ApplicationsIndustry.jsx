...
//       title: t("applicationsUseCases5.case1.title"),
//       points: t("applicationsUseCases5.case1.points", { returnObjects: true }),
//     },
//     {
//       id: 2,
//       icon: "/assets/products/Applications2.png",
//       title: t("applicationsUseCases5.case2.title"),
//       points: t("applicationsUseCases5.case2.points", { returnObjects: true }),
//     },
//     {
//       id: 3,
//       icon: "/assets/products/Applications3.png",
//       title: t("applicationsUseCases5.case3.title"),
//       points: t("applicationsUseCases5.case3.points", { returnObjects: true }),
//     },
//     {
//       id: 4,
//       icon: "/assets/products/Applications4.png",
//       title: t("applicationsUseCases5.case4.title"),
//       points: t("applicationsUseCases5.case4.points", { returnObjects: true }),
//     },
//   ];
...
//         {t("applicationsUseCases5.sectionTitle")}
//       </h2>
        ...
        {useCases.map((item) => (
          ...
          >
            <div className="flex flex-col items-center text-center">
              ...
              <span className="w-20 h-[2px] bg-[#FACC48] my-2" />
              <ul className="text-[#363636] group-hover:text-white space-y-2 text-md font-semibold mt-1 mb-2">
                {(Array.isArray(item.points) ? item.points : [item.points]).map(
                  (point, idx) => (
                    <li key={idx}>{point}</li>
                  )
                )}
