...
//   const steel = t("materialsSizes5.steel.points", { returnObjects: true });
//   const nonFerrous = t("materialsSizes5.nonFerrous.points", { returnObjects: true });
...
export default function MaterialsSizes() {
  ...
  const steelPoints = Array.isArray(steel) ? steel : [steel];
  const nonFerrousPoints = Array.isArray(nonFerrous) ? nonFerrous : [nonFerrous];
