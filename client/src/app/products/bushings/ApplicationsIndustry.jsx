  ...
  const useCases = [
    {
      ...
      icon: "/assets/products/Applications1.png",
      title: t("applications2.case1.title"),
      points: t("applications2.case1.points", { returnObjects: true }),
    },
    {
      id: 2,
      icon: "/assets/products/Applications2.png",
      title: t("applications2.case2.title"),
      points: t("applications2.case2.points", { returnObjects: true }),
    },
    {
      id: 3,
      icon: "/assets/products/Applications3.png",
      title: t("applications2.case3.title"),
      points: t("applications2.case3.points", { returnObjects: true }),
    },
    {
      id: 4,
      icon: "/assets/products/Applications4.png",
      title: t("applications2.case4.title"),
      points: t("applications2.case4.points", { returnObjects: true }),
    },
  ];

  return (
    <section className="Section bg-white">
      <h2 className="Heading text-center">{t("applications2.sectionTitle")}</h2>
