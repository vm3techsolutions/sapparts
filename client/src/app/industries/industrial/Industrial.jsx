...
//           <h2 className="text-[#0E509E] text-4xl mb-4 font-bold hidden md:block">{t("Supporting Core Industrial Operations")}</h2>
//           <p className="Paragraph">{t("Industrial-Paragraph")}</p>
//         </div>
//       </div>
//     </div>
//   );
    ...
    <div className="Section bg-white">
      <div className="flex flex-col items-center text-center">
        ...
        <h2 className="text-[#0E509E] text-4xl mb-4 font-bold">
          {t("Supporting Core Industrial Operations")}
        </h2>
