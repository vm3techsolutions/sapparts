...
export default function IndustrialSolutionsSection() {
  ...
  const points = [
    {
      title: t("industrial_solutions_points.0.title"),
      desc: t("industrial_solutions_points.0.desc"),
    },
    {
      title: t("industrial_solutions_points.1.title"),
      desc: t("industrial_solutions_points.1.desc"),
    },
    {
      title: t("industrial_solutions_points.2.title"),
      desc: t("industrial_solutions_points.2.desc"),
    },
    {
      title: t("industrial_solutions_points.3.title"),
      desc: t("industrial_solutions_points.3.desc"),
    },
    {
      title: t("industrial_solutions_points.4.title"),
      desc: t("industrial_solutions_points.4.desc"),
    },
  ];
