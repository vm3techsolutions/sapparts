...
export default function DrivingReliabilitySection() {
  ...
  const points = [
    {
      title: t("driving_reliability_points.0.title"),
      desc: t("driving_reliability_points.0.desc"),
    },
    {
      title: t("driving_reliability_points.1.title"),
      desc: t("driving_reliability_points.1.desc"),
    },
    {
      title: t("driving_reliability_points.2.title"),
      desc: t("driving_reliability_points.2.desc"),
    },
    {
      title: t("driving_reliability_points.3.title"),
      desc: t("driving_reliability_points.3.desc"),
    },
    {
      title: t("driving_reliability_points.4.title"),
      desc: t("driving_reliability_points.4.desc"),
    }
  ];
