  ...
  return (
    <div className="Section bg-white">
      <div className="flex flex-col md:flex-row gap-8 items-start">
        {/* Mobile View - Title */}
        <h2 className="Heading block md:hidden text-center">Industrial</h2>

        {/* Left Side - Text (with hidden desktop title) */}
        <div className="flex-1 order-2 md:order-1">
          <h2 className="Heading hidden md:block">Industrial</h2>
        ...
        <div className="w-full md:w-[320px] flex-shrink-0 order-1 md:order-2">
          <Image
            src="/assets/industries/Industrial.png"
            alt="Industrial"
            width={300}
            height={370}
