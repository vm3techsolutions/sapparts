...
export default function InnovationSection() {
  ...
  return (
    <div className="mx-auto py-8 sm:py-12 md:px-12 bg-[#F6F8FC]">
      <div className="mx-auto">
        <h2 className="Heading text-center">{t("Innovation Title")}</h2>
        <p className="Paragraph text-center">{t("Innovation Desc")}</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16 max-w-3xl mx-auto">
        {innovationData.map((item) => (
          <div
            key={item.id}
            className="bg-[#0E509E] text-white rounded-md shadow-md overflow-hidden"
          >
            <Image
              src={item.image}
